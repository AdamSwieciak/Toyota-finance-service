...
$('nav li:nth-of-type(2)').click(() => {$('.centerprog').html(""); $('.centerprogt').html("");})
...
$('.mainprog .progboxm:nth-child(3)').click(() => {$('.centerprog').html(drm)
$('.centerprogt').html("");})
$('.mainprog .progboxm:nth-child(4)').click(() => {$('.centerprog').html(cc);
